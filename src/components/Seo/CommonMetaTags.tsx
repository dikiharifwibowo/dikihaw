...
export const CommonMetaTags = () => {
  ...
  return (
    <Head>
      ...
      <meta ref={themeMetaRef} name="theme-color" content="#111820" />
      ...
      <link href="https://github.com/dikiharifwibowo" rel="me authn" />
      ...
      <meta name="apple-mobile-web-app-title" content="dikiharifwibowo" />
      <meta name="application-name" content="dikiharifwibowo" />
    </Head>
  );
};
